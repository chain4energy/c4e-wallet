...
import { createBaseAccount, createDelegations, createRewards, createSingleBalance, createUnbondingDelegations } from '../utils/blockchain.data.util';
...
describe('get account', () => {
  ...
  it('connects to address', async () => {
    ...
    const account = { data: createBaseAccount() };
    const balance = { data: createSingleBalance() };
    const rewards = { data: createRewards() };
    const delegations = { data: createDelegations() };
    const undelegations = { data: createUnbondingDelegations() };

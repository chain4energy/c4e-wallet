...
export class PermissionsService{
  ...
  sidebarElementOrder(): PagesEnum[]{
    const tempPagesEnum = [PagesEnum.DASHBOARD, PagesEnum.STAKING, PagesEnum.GOVERNANCE, PagesEnum.AIRDROP,  PagesEnum.DISTRIBUTION, PagesEnum.PORTFOLIO, PagesEnum.BOOST];

<template>
  <Card>
    ...
    <template #content>
      ...
      <Button @click="deleteChargePointConnector(cpId, chargePointConnector.id)">Delete</Button>
    </template>
  </Card>
</template>
...
const deleteChargePointConnector = (cpId: string, id: number) => {
  chargeStore.deleteChargePointConnector(cpId, id)
}
</script>

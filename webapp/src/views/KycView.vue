...
<!--    <div v-for="tier in tierList" :key="tier" id="app" style="margin:10px">-->
<!--      <synaps-verify-->
<!--        :sessionId="sessionId"-->
...
import {KycStepName} from "@/models/user/kyc";
    ...
    steps: [
      {
       ...
       state: useUserServiceStore().getStepStatus(KycStepName.IDENTITY)
      }
    ],
    tier: 8270
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        state: useUserServiceStore().getStepStatus(KycStepName.LIVENESS)
      }
    ],
    tier: 6406
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        state: useUserServiceStore().getStepStatus(KycStepName.PHONE)
      }
    ],
    tier: 8207
  }

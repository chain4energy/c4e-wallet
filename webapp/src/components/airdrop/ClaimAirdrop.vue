    ...
    <div class="claimAirDrop" v-if="isLoggedIn && address">
      ...
      <div class="claimAirDrop__total">
        <div class="claimAirDrop__container">
          <h4 class="claimAirDrop__header">{{$t('AIRDROP.TOTAL_HEADER')}}</h4>
      ...
      <div class="claimAirDrop__total" v-for="campaignRecord in airdropClaimRecord" :key="campaignRecord.id">
        <div class="claimAirDrop__container">
          ...
          <div class="claimAirDrop__body">
            <button v-if="campaignRecord.missions.length > 0" @click="setActiveCampaign(campaignRecord)" class="claimAirDrop__showBtn">{{activeCampain === campaignRecord? $t('AIRDROP.HIDE_MISSIONS') : $t('AIRDROP.SHOW_MISSIONS')}}</button>
